...
if(isset($postdata)){
	...
	if (isset($request->startDate)) {
     ...
     // ON RECUPERE TOUS LES TICKETS PAR JOUR 
			...
			$sql = "SELECT date,total_euro,total_euro_du,p_espece_euro,p_cb,p_cheque_euro,id_caisse,id_ticket	 FROM table_client_ticket WHERE date >= '$startDate' AND  date <= '$endDate'";
...
if ($journaux != "") {
	echo json_encode(array('response' => 1, 'journaux'  => $journaux));
}
