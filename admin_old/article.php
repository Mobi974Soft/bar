...
if(isset($_POST['famille']) && isset($_POST['designation'])){
    ...
    if(!validate_EAN13Barcode($gencode) or !ean_check($gencode)){
                            ...
                            <div class="form-groupt row" style="padding: 30px 0;justify-content: space-around;">
                                <!--                            <div class="col-md-4">-->
                                    ...
                                    <div class="col-md-8 mx-auto">
                                        <button type="button" onclick="window.location.href = document.referrer;" class="btn btn-dark btn-lg">Retour</button>
