...
if(isset($postdata)){
	...
	if(isset($request->startDate,$request->endDate)){
		...
		foreach ($period as $key => $value) {
			...
			$sql = "SELECT date,p_espece_euro,p_cheque_euro,p_cb FROM table_client_ticket WHERE  date like '%$startDate%'";
		...
		$total_periode = $espece+$cb+$cheque;
		$data[] = array("TOTAL",$espece,$cb,$cheque,$total_periode);
